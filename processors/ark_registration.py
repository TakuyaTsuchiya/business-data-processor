...
class ArkConfig:
    ...
    OUTPUT_COLUMNS = [
        ...
        "保証人１カナ",  # 59番目 ★重要: 全角数字
        "保証人１契約者との関係",  # 60番目
        "保証人１生年月日",  # 61番目 ★重要: 全角数字
        "保証人１郵便番号",  # 62番目
        "保証人１住所1",  # 63番目
        "保証人１住所2",  # 64番目
        "保証人１住所3",  # 65番目
        "保証人１TEL自宅",  # 66番目 ★重要: 全角数字
        "保証人１TEL携帯",  # 67番目 ★重要: 全角数字
        "保証人２氏名",  # 68番目 ★重要: 全角数字
        "保証人２カナ",  # 69番目 ★重要: 全角数字
        "保証人２契約者との関係",  # 70番目
        "保証人２生年月日",  # 71番目 ★重要: 全角数字
        "保証人２郵便番号",  # 72番目
        "保証人２住所1",  # 73番目
        "保証人２住所2",  # 74番目
        "保証人２住所3",  # 75番目
        "保証人２TEL自宅",  # 76番目 ★重要: 全角数字
        "保証人２TEL携帯",  # 77番目 ★重要: 全角数字
        "緊急連絡人１氏名",  # 78番目 ★重要: 全角数字
        "緊急連絡人１カナ",  # 79番目 ★重要: 全角数字
        "緊急連絡人１契約者との関係",  # 80番目
        "緊急連絡人１郵便番号",  # 81番目
        "緊急連絡人１現住所1",  # 82番目 ★重要: 全角数字
        "緊急連絡人１現住所2",  # 83番目 ★重要: 全角数字
        "緊急連絡人１現住所3",  # 84番目 ★重要: 全角数字
        "緊急連絡人１TEL自宅",  # 85番目 ★重要: 全角数字
        "緊急連絡人１TEL携帯",  # 86番目 ★重要: 全角数字
        "緊急連絡人２氏名",  # 87番目 ★重要: 全角数字
        "緊急連絡人２カナ",  # 88番目 ★重要: 全角数字
        "緊急連絡人２契約者との関係",  # 89番目
        "緊急連絡人２郵便番号",  # 90番目
        "緊急連絡人２現住所1",  # 91番目 ★重要: 全角数字
        "緊急連絡人２現住所2",  # 92番目 ★重要: 全角数字
        "緊急連絡人２現住所3",  # 93番目 ★重要: 全角数字
        "緊急連絡人２TEL自宅",  # 94番目 ★重要: 全角数字
        "緊急連絡人２TEL携帯",  # 95番目 ★重要: 全角数字
        "保証入金日",  # 96番目
        "保証入金者",  # 97番目
        "引落銀行CD",  # 98番目
        "引落銀行名",  # 99番目
