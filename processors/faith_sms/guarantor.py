...
def process_faith_sms_guarantor_data(file_content: bytes, payment_deadline_date: date) -> Tuple[pd.DataFrame, List[str], str, dict]:
    """
    フェイスSMS保証人データ処理（Streamlit対応版）
    ...
    try:
        ...
        raise Exception(f"FAITH SMS保証人処理エラー: {str(e)}")
