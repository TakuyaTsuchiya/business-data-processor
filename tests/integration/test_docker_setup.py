...
"'''
    ...
    def test_processor_imports(self):
        ...
        processors = [
            # ミライル（6種類 - 統合版ラッパー使用）
            ("mirail_contract_without10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_contract_without10k_data"),
            ("mirail_contract_with10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_contract_with10k_data"),
            ("mirail_guarantor_without10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_guarantor_without10k_data"),
            ("mirail_guarantor_with10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_guarantor_with10k_data"),
            ("mirail_emergencycontact_without10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_emergency_contact_without10k_data"),
            ("mirail_emergencycontact_with10k", "from processors.mirail_autocall.unified_wrapper import process_mirail_emergency_contact_with10k_data"),
