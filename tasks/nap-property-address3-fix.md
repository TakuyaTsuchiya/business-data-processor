...
### 背景
ナップ新規登録のCSV出力において、O列（物件住所3）に物件名と部屋番号が含まれてしまっている。

### 現状
- O列（物件住所3）: `番地 + 物件名 + 部屋番号`
...
- [ ] 開発ブランチ作成: `fix/nap-property-address3`
- [ ] テスト作成（Red）
  - [ ] 物件住所3が番地のみになることを検証するテスト
  - [ ] 既存テストの期待値修正
- [ ] 実装（Green）
  - [ ] `map_property_info`の物件住所3結合ロジック修正
- [ ] 全テスト実行・確認
- [ ] コミット
- [ ] PR作成
